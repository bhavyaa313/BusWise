    ...
    <div class="container-fluid d-flex justify-content-center align-items-center h-100 mb-5 ">
        <div class="capsule bg-dark text-white d-flex flex-row">
            ...
            <div class="container text-center">
                <div>
                    <form method="post" action="${pageContext.request.contextPath}/search/${userId}"  id="searchForm">
                        <div class="row mb-5">
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/"+ ${userId}+ "/getSources",
            type: 'GET',
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/" + ${userId}+ "/getDestination",
            type: 'GET',
