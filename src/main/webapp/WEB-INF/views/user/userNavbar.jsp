        ...
        <div class="collapse navbar-collapse w-100 d-none d-lg-inline align-items-center d-flex justify-content-center mb-3"
            ...
            <ul class="navbar-nav nav-underline">
                ...
                <li class="nav-item mx-2">
                    <a href="${pageContext.request.contextPath}/user/user-dashboard/${sessionScope.userId}" class="nav-link ${active1} ">Home</a>
                </li>
<%--                <li class="nav-item mx-2" id="myProfile">--%>
<%--                    <a href="${pageContext.request.contextPath}/user/myProfile/${sessionScope.userId}" class="nav-link ${active2} ">My Profile</a>--%>
<%--                </li>--%>

                <li class="nav-item mx-2" id="myBookings">
                    <a href="${pageContext.request.contextPath}/user/myBookingsView/${sessionScope.userId}" class="nav-link ${active6}">My Bookings</a>
                </li>

                <li class="nav-item mx-2" id="busLocation">
                    <a href="${pageContext.request.contextPath}/user/bus-location/${sessionScope.userId}" class="nav-link ${active10}">Bus Location</a>
                </li>

            </ul>

            <div class="d-flex ms-auto" >
                <h3 class="mx-3">Hello, ${sessionScope.name}</h3>
<%--                <button class="btn p-0 mx-3"> <i class="bi bi-person-circle h3 "></i> </button>--%>

                    <div class="dropdown">

                        <button type="button" class="btn p-0 mx-3 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-person-circle h3"></i>
                        </button>
                        <ul class="dropdown-menu">
                            <li>  <a href="${pageContext.request.contextPath}/user/myProfile/${sessionScope.userId}" class="dropdown-item h5">My Profile</a></li>
                            <li>  <a href="${pageContext.request.contextPath}/user/mywallet/${sessionScope.userId}" class="dropdown-item h5">My Wallet</a></li>
                        </ul>
                    </div>
        ...
        <div class=" offcanvas offcanvas-start d-sm-block d-lg-none bg-white" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-body">
                ...
                <ul class="navbar-nav nav-underline">
                    ...
                    <li class="nav-item mx-2">
                        <a href="${pageContext.request.contextPath}/user-dashboard/${sessionScope.userId}" class="nav-link ${active1} ">Home</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a href="${pageContext.request.contextPath}/user/myProfile/${sessionScope.userId}" class="nav-link ${active2} ">My Profile</a>
                    </li>
                ...
                <div class="d-flex ms-auto" id="logout">
                    <h3 class="mx-3">Welcome - ${sessionScope.name}</h3>
                    <a type="button" href="${pageContext.request.contextPath}/logout" class="btn btn-outline-dark mx-2 lo">Logout</a>
