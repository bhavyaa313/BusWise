...
<div class="container mt-5 bg-light" >
    ...
    <div class="text-center mt-4">
        ...
        <p class="d-flex"><span class="ms-auto  "><a class="btn btn-outline-danger btn-lg" href="${pageContext.request.contextPath}/user/user-dashboard/${userId}" id="backToHome">Go to HomePage</a></span></p>
    </div>
