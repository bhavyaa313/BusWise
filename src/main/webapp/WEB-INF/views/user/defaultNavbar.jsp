    ...
    <div class="container-fluid flex-column">
        ...
        <div class="collapse navbar-collapse w-100 d-none d-lg-inline align-items-center d-flex justify-content-center mb-3"
            ...
            <div class="d-flex ms-auto" id="logout">
                <h3 class="mx-3">Welcome User</h3>

                <a type="button" href="${pageContext.request.contextPath}/logout" class="btn btn-outline-dark mx-3 btn-lg lo">Login</a>
            </div>
        </div>
        ...
        <%--                </div>--%>
        <%--                &lt;%&ndash;                <span class="wlcm lo-btn">Welcome <span style="font-weight: 500;">Admin admin2</span></span>&ndash;%&gt;--%>
        <%--                <ul class="navbar-nav nav-underline">--%>

        <%--                    <li class="nav-item mx-2">--%>
        <%--                        <a href="${pageContext.request.contextPath}/admin/dashboard/${userId}" class="nav-link ">Home</a>--%>
        <%--                    </li>--%>
        <%--                    <li class="nav-item mx-2">--%>
        <%--                        <a href="${pageContext.request.contextPath}/admin/myProfile/${userId}" class="nav-link">My Profile</a>--%>
        <%--                    </li>--%>
        <%--                    <li class="nav-item mx-2">--%>
        <%--                        <a href="${pageContext.request.contextPath}/admin/buses/${userId}" class="nav-link ">Buses</a>--%>
        <%--                    </li>--%>
