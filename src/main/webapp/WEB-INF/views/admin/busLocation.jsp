...
<head>
    ...
    <title>Multiple Bus Routes with Different Start Times</title>
...
<script>
    ...
    let intervals = [];
    let routes = [];
    const speed = 90 * 1000 / 3600; // Speed in meters per second

    function fetchBusLocations() {

        console.log("Fetching bus locations...");
        fetch('${pageContext.request.contextPath}/locations') // Adjust the endpoint to your actual API endpoint
