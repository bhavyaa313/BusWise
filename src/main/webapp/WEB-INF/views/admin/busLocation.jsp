...
<div  id="container-nodata">
    ...
    <script>
        ...
        function fetchBusLocations() {
            ...
            fetch('${pageContext.request.contextPath}/locations')
        ...
        function calculateAndDisplayRoute(routeData, index, startTime) {
            ...
            directionsService.route(request, function(result, status) {
                if (status == 'OK') {
                    ...
                    calculateTravelTime(result.routes[0].legs[0].distance.value, index, startTime, routeData);
                } else {
