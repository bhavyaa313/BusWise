...
<%--    &lt;%&ndash;function deletebutton(routeId) {&ndash;%&gt;--%>



<%--    &lt;%&ndash;    $.ajax({&ndash;%&gt;--%>
<%--    &lt;%&ndash;        url:  ${userId} +"/deleteRoute/" + routeId,&ndash;%&gt;--%>
<%--    &lt;%&ndash;        type: "POST", //&ndash;%&gt;--%>
<%--    &lt;%&ndash;        success: function (response) {&ndash;%&gt;--%>

<%--    &lt;%&ndash;            ajaxCallSearch();&ndash;%&gt;--%>

<%--    &lt;%&ndash;            console.log("Item deleted successfully:", response);&ndash;%&gt;--%>
<%--    &lt;%&ndash;            var alert = `<div class="alert alert-success alert-dismissible fade show" role="alert">`&ndash;%&gt;--%>
<%--    &lt;%&ndash;            alert += `<strong>Success! </strong>`;&ndash;%&gt;--%>
<%--    &lt;%&ndash;            alert+=`Route has been deleted successfully.`;&ndash;%&gt;--%>
<%--    &lt;%&ndash;            alert+=`<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>`;&ndash;%&gt;--%>
<%--    &lt;%&ndash;            alert+=`</div>`;&ndash;%&gt;--%>
<%--    &lt;%&ndash;            console.log(alert)&ndash;%&gt;--%>
<%--    &lt;%&ndash;            $('#alertContainerDelete').append(alert);&ndash;%&gt;--%>

<%--    &lt;%&ndash;        },&ndash;%&gt;--%>
<%--    &lt;%&ndash;        error: function(jqXHR, textStatus, errorThrown) {&ndash;%&gt;--%>
<%--    &lt;%&ndash;            console.error("Error deleting booking:", textStatus, errorThrown);&ndash;%&gt;--%>
<%--    &lt;%&ndash;            var alert = `<div class="alert alert-danger alert-dismissible fade show" role="alert">`;&ndash;%&gt;--%>
<%--    &lt;%&ndash;            alert+=`<strong>Error! </strong>`;&ndash;%&gt;--%>
<%--    &lt;%&ndash;            alert+=`An error occurred while deleting route.`;&ndash;%&gt;--%>
<%--    &lt;%&ndash;            alert+=`<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>`;&ndash;%&gt;--%>
<%--    &lt;%&ndash;            alert+=`</div>`&ndash;%&gt;--%>
<%--    &lt;%&ndash;            $('#alertContainerDelete').append(alert);&ndash;%&gt;--%>
<%--    &lt;%&ndash;        }&ndash;%&gt;--%>
            ...
            <form method="post" id="myForm">
                <div class="modal-body">
                    <div class="row g-2">
                        ...
                        <div class="col-md-4">
                            <div class=" mb-3">
                                <label for="destination" class="dm">Destination</label>
                                <input type="text" class="form-control" id="destination" placeholder="destination" name="destination">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class=" mb-3">
                                <label for="distance" class="dm">Distance</label>
...
<script>
    ...
    document.getElementById('addSubrouteButton1').addEventListener('click', () => {
        ...
        <div class="row g-2 row1" id="subroute-row-`+currentCount+`">
            ...
            <div class="col-md-2">
                <button type="button" class="btn btn-danger btn-sm" onclick="removeSubroute(this)">-</button>
            </div>
        </div>
    `;
